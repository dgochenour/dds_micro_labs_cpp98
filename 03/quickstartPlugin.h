...
namespace myModule {
    ...
    * -------------------------------------------------------------------------- */
    ...
    #define myType_cdr_serialize_key myType_cdr_serialize
    #define myType_cdr_deserialize_key myType_cdr_deserialize
    #define myType_get_serialized_key_size myType_get_serialized_sample_size
